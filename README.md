...
disaster recovery in Rust.

## 🚀 Overview
This repository contains a professional implementation of **Rust Disaster Recovery**. It is designed with clean code principles and focuses on functionality and reliability.
